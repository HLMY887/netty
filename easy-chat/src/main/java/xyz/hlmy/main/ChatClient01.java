...
public class ChatClient01 {
    public static void main(String[] args) {
        EventLoopGroup group01 = new NioEventLoopGroup();
        try {
            Bootstrap bootstrap = new Bootstrap();
            bootstrap.group(group01).channel(NioSocketChannel.class).handler(new ChannelInitializer<SocketChannel>() {
                @Override
